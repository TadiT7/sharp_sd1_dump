...
case "$fqcaudio" in
    ...
    /system/bin/tinymix 'DEC1 Volume' 93 > /dev/null 2>&1
    /system/bin/tinymix 'Loopback MCLK' 'ENABLE' > /dev/null 2>&1
    /system/bin/tinymix 'RX1 Digital Volume' 90 > /dev/null 2>&1
    /system/bin/tinymix 'RX2 Digital Volume' 90 > /dev/null 2>&1
		;;
	"10")
